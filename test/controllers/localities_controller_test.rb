...
class LocalitiesControllerTest < ActionController::TestCase
  ...
  test "should create locality" do
    assert_difference('Locality.count') do
      post :create, locality: { name: @locality.name, postal_code: @locality.postal_code, province_id: @locality.province_id }
    end
  ...
  test "should update locality" do
    patch :update, id: @locality, locality: { name: @locality.name, postal_code: @locality.postal_code, province_id: @locality.province_id }
    assert_redirected_to locality_path(assigns(:locality))
  end
