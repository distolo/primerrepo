...
class AccountUsersControllerTest < ActionController::TestCase
  ...
  test "should create account_user" do
    assert_difference('AccountUser.count') do
      post :create, account_user: { account_id: @account_user.account_id, permission_level: @account_user.permission_level, user_id: @account_user.user_id }
    end
  ...
  test "should update account_user" do
    patch :update, id: @account_user, account_user: { account_id: @account_user.account_id, permission_level: @account_user.permission_level, user_id: @account_user.user_id }
    assert_redirected_to account_user_path(assigns(:account_user))
  end
