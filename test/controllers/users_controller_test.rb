...
class UsersControllerTest < ActionController::TestCase
  ...
  test "should create user" do
    assert_difference('User.count') do
      post :create, user: { confirmation_sent_at: @user.confirmation_sent_at, confirmation_token: @user.confirmation_token, confirmed_at: @user.confirmed_at, current_sign_in_at: @user.current_sign_in_at, current_sign_in_ip: @user.current_sign_in_ip, email: @user.email, encrypted_password: @user.encrypted_password, failed_attempts: @user.failed_attempts, last_sign_in_at: @user.last_sign_in_at, last_sign_in_ip: @user.last_sign_in_ip, remember_created_at: @user.remember_created_at, reset_password_sent_at: @user.reset_password_sent_at, reset_password_token: @user.reset_password_token, sign_in_count: @user.sign_in_count, unconfirmed_email: @user.unconfirmed_email, unlock_token: @user.unlock_token }
    end
