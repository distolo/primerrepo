class LocalitiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @locality.save
        format.html { redirect_to :action => :index, notice: 'Locality was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @locality.update(locality_params)
        format.html { redirect_to :action => :index, notice: 'Locality was successfully updated.' }
  ...
  private
    ...
    def locality_params
      params.require(:locality).permit(:province_id, :name, :postal_code)
    end
end
