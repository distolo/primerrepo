class ProvincesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @province.save
        format.html { redirect_to :action => :index, notice: 'Province was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @province.update(province_params)
        format.html { redirect_to :action => :index, notice: 'Province was successfully updated.' }
  ...
  private
    ...
    def province_params
      params.require(:province).permit(:country_id, :name)
    end
end
