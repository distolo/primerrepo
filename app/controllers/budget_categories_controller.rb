class BudgetCategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @budget_category.save
        format.html { redirect_to :action => :index, notice: 'Budget category was successfully created.' }
        format.json { render action: 'show', status: :created, location: @budget_category }
      else
  ...
  private
    ...
    def budget_category_params
      params.require(:budget_category).permit(:budget_id, :name)
    end
end
